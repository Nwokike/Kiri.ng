...
def social_link_card(url):
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-link-45deg" viewBox="0 0 16 16">
      ...
      <path d="M6.586 4.672A3 3 0 0 0 7.414 9.5l.775-.776a2 2 0 0 1-.896-3.346L9.12 3.55a2 2 0 1 1 2.83 2.83l-.793.792c.112.42.155.855.128 1.287l1.07-1.071a3 3 0 1 0-4.243-4.243L6.586 4.672z"/>
    </svg>
    """
    text = "Visit Website"
    ...
    if 'instagram.com' in hostname:
        ...
        bg_color = "bg-danger"
    elif 'wa.me' in hostname or 'whatsapp.com' in hostname:
        icon_svg = """
    ...
    <a href="{url}" target="_blank" rel="noopener noreferrer" class="text-decoration-none">
        <div class="card text-white {bg_color} mb-3">
            <div class="card-body d-flex align-items-center">
                {icon_svg}
                <h5 class="card-title mb-0 ms-3">{text}</h5>
            </div>
        </div>
    </a>
    """
